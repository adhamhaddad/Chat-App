...
const LoginPage = () => {
  ...
  return (
    <Box className='content-left' sx={{ height: '100vh', display: 'flex' }}>
      {!hidden ? (
        <Box sx={{ flex: 1, display: 'flex', position: 'relative', alignItems: 'center', justifyContent: 'center' }}>
          <LoginIllustrationWrapper>
            <LoginIllustration alt='login-illustration' src={`/images/auth/${imageSource}-${theme.palette.mode}.png`} />
          </LoginIllustrationWrapper>
          ...
          <BoxWrapper>
            ...
            <Alert icon={false} sx={{ py: 3, mb: 6, ...bgColors.primaryLight, '& .MuiAlert-message': { p: 0 } }}>
              <Typography variant='caption' sx={{ mb: 2, display: 'block', color: 'primary.main' }}>
                Admin: <strong>adham@admin.com</strong> / Pass: <strong>adham</strong>
              </Typography>
